        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="relative flex items-center justify-center min-h-[400px] lg:min-h-[500px]">
            ...
            <div className="absolute top-0 left-0">
              ...
              {/* Dashed line */}
              <svg
                className="absolute top-full left-1/2 -translate-x-1/2 w-2 h-24"
            ...
            <div className="absolute top-0 left-1/2">
              ...
              {/* Dashed line */}
              <svg
                className="absolute top-full left-1/2 -translate-x-1/2 w-2 h-32"
                style={{ overflow: "visible" }}
              >
                <line
                  x1="1"
            ...
            <div className="absolute top-1/2 -translate-y-1/2 left-0">
              ...
              {/* Dashed line */}
              <svg
                className="absolute top-1/2 -translate-y-1/2 left-full w-24 h-2"
                style={{ overflow: "visible" }}
              >
                <line
                  x1="10"
            ...
            {/* Central n8n node */}
            <div className="relative z-10 bg-white border-2 border-gray-200 rounded-2xl shadow-lg px-16 py-4 flex items-center gap-3">
            ...
            <div className="absolute top-1/2 -translate-y-1/2 right-0 ">
              ...
              {/* Dashed line */}
              <svg
                className="absolute top-1/2 -translate-y-1/2 right-full w-24 h-2"
                style={{ overflow: "visible" }}
              >
                <line
                  x1="80"
            ...
            <div className="absolute bottom-0 left-1/2">
              ...
              {/* Dashed line */}
              <svg
                className="absolute bottom-full left-1/2 -translate-x-1/2 w-2 h-24"
                style={{ overflow: "visible" }}
              >
                <line
                  x1="1"
          ...
          <div className="space-y-6">
            <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
              Think of{" "}
              <strong className="font-semibold text-gray-900">n8n</strong> as a
              powerful toolkit that connects different apps and services to
              handle repetitive tasks for you. It uses a simple, visual
              drag-and-drop editor where you link together{" "}
              <strong className="font-semibold text-gray-900">nodes</strong> to
              create a{" "}
              <strong className="font-semibold text-gray-900">workflow</strong>.
              Each node is a step in your process.
            </p>
            ...
            <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
              ...
              that's built for flexibility. You can write your own custom code,
              connect to internal databases, integrate AI agents, or use an HTTP
              node to talk to virtually any service with an API.
            </p>
          </div>
        </div>
      </div>
